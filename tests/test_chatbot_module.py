...
class CheckChatbotModule(SettingBase):
    def test_session_start(self):
        ...
        with open('tests/data/chatbot-module/session_start_output.json', 'r', encoding = 'utf-8') as file:
    ...
    def test_welcome(self):
        ...
        response = self.client.get(url_for('rasa_api.welcome') 
                                   + "?sender_id=116287698501129823679", follow_redirects=True)
        with open('tests/data/chatbot-module/welcome_output.json', 'r', encoding = 'utf-8') as file:
            output = json.load(file)
        self.assertEqual(response.json,output)
    ...
    def test_base_flow_rasa(self):
        ...
        with open('tests/data/chatbot-module/base_flow_rasa_output.json', 'r', encoding = 'utf-8') as file:
            output = json.load(file)
        self.assertEqual(response.json,output)
